...
class RecipeView extends View { 
    ...
    addHandlerRenderRecipes(handler){
            this._parentElement.addEventListener('click', function(e){
            const btn = e.target.closest('.add--shopping-list__btn');
            if(!btn)return;
            handler();
        })
    }
    ...
    return  `
        ...
        <div class="recipe__directions">
            ...
            <br>
            <p
            class="btn--small add--shopping-list__btn"
            target="_blank"
            >
    ...
    addHandlerRender(handler){
        // I would just use 'hashchange' without load
